          ...
          <div className="max-w-[450px] h-[600px] mx-auto rounded bg-black/75 text-white">
            <div className="max-w-[320px] mx-auto py-16">
                ...
                <form className="w-full flex flex-col py-6 ">
                    ...
                    <button className="bg-red-600 py-3 my-5 rounded ">Sign In</button>
                    <div className="flex justify-between items-center text-sm text-gray-400">
                        <p><input className="mr-1" type="checkbox"/> Remember me</p>
                        <p>Need help?</p>
                    </div>
                    <p className="mt-16 "> <span className="text-gray-600">New to MovieToon? </span> <Link to="/signup">Sign Up</Link></p>
                </form>
            </div>
          </div>
        </div>
